...
val_pfdi_execute_pfdi_tests(uint32_t num_pe)
{
  ...
  status  |= pfdi018_entry(num_pe);
  status  |= pfdi019_entry(num_pe);
  status  |= pfdi020_entry(num_pe);
  status  |= pfdi021_entry(num_pe);
  status  |= pfdi022_entry(num_pe);
  status  |= pfdi023_entry(num_pe);
  status  |= pfdi024_entry(num_pe);
  status  |= pfdi025_entry(num_pe);
  status  |= pfdi026_entry(num_pe);
  status  |= pfdi027_entry(num_pe);
  status  |= pfdi028_entry(num_pe);
  status  |= pfdi029_entry(num_pe);
  status  |= pfdi030_entry(num_pe);
  status  |= pfdi031_entry(num_pe);
